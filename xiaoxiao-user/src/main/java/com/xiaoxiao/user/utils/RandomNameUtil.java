...
public class RandomNameUtil {
    ...
    private static final String[] DOUBLE_SUR_NAME = {"万俟", "司马", "上官", "欧阳", "夏侯", "诸葛", "闻人", "东方",
    ...
    private static final String[] WORD = {"一", "乙", "二", "十", "丁", "厂", "七", "卜", "人", "入", "八", "九", "几", "儿", "了", "力", "乃", "刀", "又",
